...
const getClient = (model: string, prismaClient: any = prisma): any => {
  const camelModel = model.charAt(0).toLowerCase() + model.slice(1);
  const client =
    (prismaClient as any)[model] ||
    (prismaClient as any)[camelModel] ||
    (prismaClient as any)[model.toLowerCase()];
  if (!client) {
    const error = new Error("MODEL_NOT_FOUND") as any;
 ...
 */
const createTxWrapper = (prismaClient: any) => ({
  findMany: ({ model, where = {}, include, select, orderBy }: any) =>
  ...
  findOne: ({ model, where, include, select }: any) =>
  ...
  findFirst: ({ model, where, include, select }: any) =>
  ...
  create: ({ model, data, include, select }: any) =>
    getClient(model, prismaClient).create({
      data,
      ...(include ? { include } : {}),
      ...(select ? { select } : {}),
    }),
  createMany: ({ model, data, skipDuplicates }: any) =>
    getClient(model, prismaClient).createMany({ data, skipDuplicates }),

  updateOne: ({ model, where, data, include, select }: any) =>
  ...
  upsertOne: ({ model, where, update, create, include, select }: any) =>
  ...
  deleteMany: ({ model, where = {} }: any) =>
    getClient(model, prismaClient).deleteMany({ where }),

  deleteOne: ({ model, where = {}, include, select }: any) =>
 ...
 */
export const transaction = async (actionsOrCallback: any) => {
...
export const create = ({ model, data, include, select }: any) => {
...
export const createMany = ({ model, data, skipDuplicates }: any) => {
  return getClient(model).createMany({ data, skipDuplicates });
};

export const findOne = ({ model, where, include, select }: any) => {
...
export const findFirst = ({ model, where, include, select }: any) => {
...
export const updateOne = ({ model, where, data, include, select }: any) => {
...
export const updateMany = ({ model, where, data }: any) => {
...
export const deleteMany = ({ model, where = {} }: any) => {
  return getClient(model).deleteMany({ where });
};

export const deleteOne = ({ model, where = {}, include, select }: any) => {
...
export const count = ({ model, where = {} }: any) => {
  return getClient(model).count({ where });
};

export const max = ({ model, where = {} }: any) => {
  return getClient(model).max({ where });
};
